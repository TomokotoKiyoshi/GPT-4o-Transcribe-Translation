...
class RealtimeJapaneseTranscriber:
    ...
    def __init__(self, api_key):
        ...
        self.translations = {
            'ja': {
                'window_title': 'リアルタイム字幕転写・翻訳システム',
                'main_title': 'リアルタイム字幕転写・翻訳システム',
                ...
                'system_info': 'システム情報',
                'system_idle': 'システム待機中...',
                'transcription_time': '転写応答時間',
                'translation_time': '翻訳応答時間',
                'buffer_length': 'バッファ長'
            },
            'en': {
            ...
            'zh': {
                'window_title': '实时字幕转录与翻译系统',
                'main_title': '实时字幕转录与翻译系统',
                'subtitle': '实时字幕转录与翻译系统',
                'keyword_label': '关键词',
                ...
                'system_info': '系统信息',
                'system_idle': '系统空闲...',
                'transcription_time': '转录响应时间',
                'translation_time': '翻译响应时间',
                'buffer_length': '缓冲区长度'
            },
            'ko': {
                'window_title': '실시간 자막 전사 및 번역 시스템',
                'main_title': '실시간 자막 전사 및 번역 시스템',
                'subtitle': '실시간 자막 전사 및 번역 시스템',
                'keyword_label': '키워드',
                ...
                'system_info': '시스템 정보',
                'system_idle': '시스템 유휴...',
                'transcription_time': '전사 응답 시간',
                'translation_time': '번역 응답 시간',
                'buffer_length': '버퍼 길이'
            }
        }
